...
INSERT INTO book_genre (book_genre_id, book_genre_name) VALUES
                                                            (1, 'Fiction'),
                                                            (2, 'Non-Fiction'),
                                                            (3, 'Science Fiction'),
                                                            (4, 'Mystery'),
...
INSERT INTO book_author (book_author_id, book_author_name) VALUES
                                                               (1, 'George Orwell'),
                                                               (2, 'J.K. Rowling'),
                                                               (3, 'Isaac Asimov'),
                                                               (4, 'Agatha Christie'),
...
INSERT INTO book_publisher (book_publisher_id, book_publisher_name) VALUES
                                                                        (1, 'Penguin Books'),
...
INSERT INTO book_location_floor (book_location_floor_id, book_location_floor_number) VALUES
                                                                                         (1, 1),
                                                                                         (2, 2),
                                                                                         (3, 3);

INSERT INTO book_location_shelf (book_location_shelf_id, book_location_shelf_number) VALUES
                                                                                         (1, 101),
                                                                                         (2, 102),
                                                                                         (3, 201),
                                                                                         (4, 202),
...
INSERT INTO zip (id, zip_code)  VALUES
                                    (1, '1010'),
                                    (2, '8010'),
                                    (3, '7000'),
                                    (4, '7423'),
...
INSERT INTO customer (customer_id, first_name, last_name, country_id, city_id, zip_id, town_id, street_id, streetnumber)  VALUES
                                                                                                                              (1,  'Anna',    'Müller',    1, 1, 1, 1, 1, '12A'),
...
INSERT INTO CustomerCard (customer_card_id, customer_id)  VALUES
                                                              (10,  1),
                                                              (9,  2),
                                                              (8,  3),
                                                              (7,  4),
...
INSERT INTO book (isbn, book_title, book_genre_id, book_publisher_id) VALUES
...
INSERT INTO author_book_map (book_author_id, isbn) VALUES
                                                       (1, '9780451524935'),
                                                       (1, '9780451524942'),
                                                       (2, '9780747532699'),
                                                       (2, '9780747532705'),
...
INSERT INTO book_location (book_location_id, book_location_floor_id, book_location_shelf_id) VALUES
                                                                                                 (1,  1, 1),
                                                                                                 (2,  1, 2),
                                                                                                 (3,  2, 3),
                                                                                                 (4,  2, 4),
...
INSERT INTO book_stock_log (book_stock_log_id, book_is_in_stock, isbn, book_location_id) VALUES
                                                                                             (1,  TRUE,  '9780451524935', 1),
...
INSERT INTO event (event_id, event_name, event_starts_at_ts, event_type_id) VALUES
                                                                                (1, 'Orwell Reading Night',        '2026-07-10 19:00:00', 1),
...
INSERT INTO customer_event_map (customer_id, event_id) VALUES
                                                           (1, 1), (2, 1), (3, 1),
                                                           (1, 2), (4, 2), (5, 2),
                                                           (6, 3), (7, 3),
                                                           (8, 4), (9, 4), (10, 4),
...
INSERT INTO book_event_map (book_event_id, isbn) VALUES
                                                     (1, '9780451524935'),
                                                     (1, '9780451524942'),
                                                     (2, '9780747532699'),
                                                     (2, '9780747532705'),
